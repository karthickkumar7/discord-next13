        ...
        <>
            <div className="w-5/6 md:w-[600px] h-[230px] md:h-[300px] p-4 rounded-lg bg-white absolute z-10 top-[50%] right-[50%] translate-x-[50%] -translate-y-[50%]">
                ...
                <div className="mt-4 md:space-y-4">
                    ...
                    />
                    <button className="w-[200px] block px-2 py-1 md:py-2 mt-4 bg-burple text-white rounded-lg uppercase hover:opacity-80 duration-300 active:opacity-100 active:shadow-md">
                        send invite
                    </button>
                </div>
            </div>
